...
/*
	...
	Description: Scroll Nav Fixed allows users to build custom one-page fixed navigation menu. It offers full controll and default blueprint set that is easy to customize and place on various portions of your page.
	Version: 3.1
	V3: true
